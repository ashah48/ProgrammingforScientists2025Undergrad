...
class Rectangle:
    ...
    #with dataclass, we can define our attributes closer to the language-neutral way
    width: float = 1.0
    height: float = 1.0
    rotation: float = 0.0
    x1: float = 0.0
...
def main():
    ...
    y1 = 3.0
    radius = 2.0
    my_circle = Circle(x1 = x1, y1 = y1, radius = radius)  # x1 = 1.0, y1 = 3.0, radius = 2.0

    r = Rectangle(x1 = 3.0, y1 = 5.0)  # some languages might get mad, Python never gets mad
